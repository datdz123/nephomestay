...
<section class="qd-404 bg-black w-full">
	<div class="container mx-auto">
		<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1920 1080">
			...
			<g id="Layer_12 yellow-back-fig" data-name="Layer 12">
				...
				<rect class="qd_404-1" x="680.91" y="871.98" width="513.38" height="8.39" rx="4.19"
					ry="4.19" />
				<path class="qd_404-1"
				...
				<rect class="qd_404-1" x="492.21" y="920.64" width="249.8" height="8.39" rx="4.19"
					ry="4.19" />
				<path class="qd_404-1"
				...
				<rect class="qd_404-1" x="915.6" y="981.47" width="54.72" height="8.39" rx="4.19"
					ry="4.19" />
				<path class="qd_404-1"
				...
				<rect class="qd_404-1" x="997.06" y="981.47" width="78.11" height="8.39" rx="4.19"
					ry="4.19" />

				<g id="round-conf">
					<path class="qd_404-1 circle c1"
			...
			<g id="fortyfour" data-name="Layer 2">
				<g class="four a">
					...
					<rect class="qd_404-2" x="233.74" y="391.14" width="120.71" height="466.29"
						rx="57.1" ry="57.1" transform="translate(918.39 330.19) rotate(90)" />

					<rect class="qd_404-3" x="333.83" y="475.1" width="120.71" height="396.88"
						rx="60.36" ry="60.36" />

					<rect class="qd_404-3" x="197.13" y="122.89" width="120.71" height="604.75"
						rx="60.36" ry="60.36" transform="translate(290.49 -70.78) rotate(35)" />

				</g>
				<g class="four b">

					<rect class="qd_404-2" x="1558.84" y="391.91" width="120.71" height="466.29"
						rx="57.1" ry="57.1" transform="translate(2244.26 -994.14) rotate(90)" />


					<rect class="qd_404-3" x="1658.92" y="475.87" width="120.71" height="396.88"
						rx="60.36" ry="60.36" />

					<rect class="qd_404-3" x="1522.22" y="123.66" width="120.71" height="604.75"
						rx="60.36" ry="60.36" transform="translate(530.57 -830.68) rotate(35)" />

				</g>
				<path class="qd_404-3" id="ou"
			...
			<g id="umbrella" data-name="Layer 3">
				<g>
					<circle class="qd_404-4" cx="1187.53" cy="240.3" r="7.66"
			...
			<g id="clock" data-name="Layer 8">
				...
				<circle class="qd_404-5" cx="847.7" cy="247.59" r="74.66"
					transform="translate(-32.91 314.05) rotate(-20.6)" />
				<circle class="qd_404-1" cx="847.7" cy="247.59" r="63.44"
					transform="translate(-32.91 314.05) rotate(-20.6)" />
				<rect class="qd_404-3 clock-hand-1" x="845" y="189.5" width="6.04" height="58"
					rx="3.02" ry="3.02" />
				<rect class="qd_404-3 clock-hand-2" x="845" y="209.5" width="6.04" height="38"
					rx="3.02" ry="3.02" transform="translate(1611.22 -230.4) rotate(130.4)" />
				<circle class="qd_404-3" cx="847.7" cy="247.59"
			...
			<g id="box" data-name="Layer 9">
				...
				<rect class="qd_404-5" x="693.73" y="335.51" width="83.99" height="90.58"
			...
			<g id="bike" data-name="Layer 5">
				...
				<g>
					<rect class="qd_404-1" x="871.39" y="693.37" width="12.87" height="53.21"
				...
				<g>
					<circle class="qd_404-9" cx="1022.66" cy="599.55" r="11.57"
					...
					<circle class="qd_404-11" cx="1027.9" cy="587.94" r="12.99"
